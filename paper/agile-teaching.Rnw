...
One of the first steps in class design is to decide how learning objectives are going to be organized, as well as evaluated; immediately follows how these contents are going to be delivered and assessed.
