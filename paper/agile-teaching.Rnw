...
Teaching software engineering represents not only a challenge, but a series of challenges to the teacher, who needs the student to develop a series of marketable skills at the same time that development is assessed in order to obtain a grade. At the same time, mainstream software development follows an {\em agile mindset}, following the Agile Manifesto \cite{agilemanifesto},
