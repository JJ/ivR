...
In this paper we will describe the experience along 3 years in a 4th year (7th semester) subject in the Computer Science degree at the University of Granada, Spain; the subject deals with Cloud Computing, so the project needs to be based on tha final objective. But besides being the description of the experience, we will try to answer the following research questions:\begin{itemize}
\item {\bf RQ1:} Can we measure the effect of agile-inspired methodologies on the learning outcomes?
