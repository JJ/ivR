...
\item {\bf RQ1:} Is the effectivity of adopted practices revealed in the collected data?
...
\item {\bf RQ3:} Can analytics help us define a measure of successful learning experience?
\end{itemize}
